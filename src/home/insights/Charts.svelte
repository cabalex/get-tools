...
<h3>With this balance, you can eat <span style="color: {mealColor()}">{mealsLeft().toFixed(2)}</span> meals per day ({Math.floor(transactions[0].resultingBalance / MEAL_COST)} meals).</h3>
<div class="charts">
